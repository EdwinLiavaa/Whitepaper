...
As later proposal blocks accumulate in the chain after each round of collective mining, it becomes computationally impractical for any colonial or foreign attacker to rewrite or disrupt the throughput. They would have to rededicate greater proof-of-participation than the entirety of the native populace to overwhelm or invalidate the canonical chain. As long as the majority of Tonga's citizens control most proof-of-work mining power, the longest chain always represents the genuine sovereign's collective prioritized proposals.</p>
